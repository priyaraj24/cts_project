package com.app.FlightBooking.Config;
...
public class HibernateConfiguration {
	...
	@Value("${hibernate.storage_engine}")
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		hibernateProperties.put("hibernate.dialect.storage_engine", HIBERNATE_DIALECT_STORAGE_ENGINE);
